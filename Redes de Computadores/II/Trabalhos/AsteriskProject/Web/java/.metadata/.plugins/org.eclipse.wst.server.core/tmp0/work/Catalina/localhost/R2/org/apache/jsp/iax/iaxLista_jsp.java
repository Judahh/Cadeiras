...
public final class iaxLista_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t");
					...
					for(IAXRamal ramal : IAXRamalFacade.getIaxRamais()){
				
      out.write("\n");
      out.write("\t\t\t\t<li>\n");
      out.write("\t\t\t\t\t<button type=\"submit\" name=\"id\" class=\"button\" value=\"");
      out.print(ramal.getId());
      out.write('"');
      out.write('>');
      out.print(ramal.getId());
      out.write("</button>\n");
