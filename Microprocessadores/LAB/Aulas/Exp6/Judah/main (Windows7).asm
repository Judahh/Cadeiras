...
init: 
	...
	mov	hours,#12 ;inicializa hora
	mov	minutes,#23 ;inicializa minuto
	mov	seconds,#56 ;inicializa segundo
...
read: 
	mov 	b,a ;b armazena codigo lido em P1
	mov 	counter,#0
